...
// Apply a click handler for every movie link that triggers the function
var movieLinks = document.querySelectorAll('a.film');
for (var i=0; i < movieLinks.length; i++) {
	movieLinks[i].onclick = updateMessage;
}
